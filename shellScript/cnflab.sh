...
SCRIPT="sudo chmod 700 /home/ubuntu/55-cnf.yaml; sudo cp /home/ubuntu/55-cnf.yaml /etc/netplan/; sudo netplan apply; sudo sed -i 's/GRUB_CMDLINE_LINUX=""/GRUB_CMDLINE_LINUX="systemd.unified_cgroup_hierarchy=0"/g' /etc/default/grub ; sudo update-grub"
